...
(function($) {
	...
	let i = 1;
	$('.thumb').each(function(){
		let fullPath = 'galleryImages/' + folder + '/fulls/' + i + '.jpg';
		let thumbPath = 'galleryImages/' + folder + '/thumbs/' + i + '.jpg';

		$(this).find('a').attr('href', fullPath);
		$(this).find('img').attr('src', thumbPath);
		i++;
	});
